...
class TestAuthorizationManager(unittest.TestCase):
    ...
    def test_manager_denies_on_provider_error(self):
        ...
        original_authorize = manager._provider.authorize
        manager._provider.authorize = MagicMock(side_effect=Exception("Test error"))
        ...
        # Restore original
        manager._provider.authorize = original_authorize
