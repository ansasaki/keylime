...
class TestSessionControllerUpdateSession(unittest.TestCase):
    ...
    @patch("keylime.web.verifier.session_controller.VerifierAgentModel")
    def test_update_session_agent_not_enrolled(self, mock_agent_model):
        ...
        # Mock agent lookup to return no agent
    ...
    def test_update_session_authentication_failed(self, mock_create_from_memory, mock_agent_model):
        ...
        # Mock agent lookup to return an agent
    ...
    def test_update_session_success(self, _mock_delete_active, mock_create_from_memory, mock_agent_model):
...
class TestSessionControllerLegacyEndpoints(unittest.TestCase):
    ...
    def test_create_success(self, mock_create, mock_agent_model, _mock_delete_stale):
    ...
    @patch("keylime.web.verifier.session_controller.VerifierAgentModel")
    def test_create_agent_not_found(self, mock_agent_model):
        """Test create endpoint with non-existent agent."""
        # Mock agent lookup to return None
        mock_agent_model.get.return_value = None
    ...
    @patch("keylime.web.verifier.session_controller.VerifierAgentModel")
    @patch("keylime.models.verifier.auth_session.AuthSession.get_by_token")
    def test_update_success(self, mock_get, mock_agent_model):
    ...
    @patch("keylime.web.verifier.session_controller.VerifierAgentModel")
    @patch("keylime.models.verifier.auth_session.AuthSession.get_by_token")
    def test_update_not_found(self, mock_get, _mock_agent_model):
