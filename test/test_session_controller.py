...
class TestSessionControllerUpdateSession(unittest.TestCase):
    ...
    @patch("keylime.web.verifier.session_controller.session_context")
    def test_update_session_agent_not_enrolled(self, mock_session_context):
    ...
    def test_update_session_authentication_failed(self, mock_create_from_memory, mock_session_context):
    ...
    def test_update_session_success(
        self, mock_config, _mock_delete_active, mock_create_from_memory, mock_session_context
    ):
...
class TestSessionControllerLegacyEndpoints(unittest.TestCase):
    ...
    def test_create_success(self, mock_create, mock_session_context, _mock_delete_stale):
    ...
    @patch("keylime.web.verifier.session_controller.session_context")
    def test_create_agent_not_found(self, mock_session_context):
    ...
    @patch("keylime.web.verifier.session_controller.session_context")
    @patch("keylime.models.verifier.auth_session.AuthSession.get_by_token")
    def test_update_success(self, mock_get, mock_session_context):
    ...
    @patch("keylime.web.verifier.session_controller.session_context")
    @patch("keylime.models.verifier.auth_session.AuthSession.get_by_token")
    def test_update_not_found(self, mock_get, _mock_session_context):
