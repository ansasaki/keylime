...
validation, TPM verification, and error handling for v3 API.
"""
...
def _v3_controller() -> Any:
    """Create an EvidenceController with a mocked action handler for v3."""
    mock_action_handler = MagicMock()
    mock_action_handler.request.path = "/v3.0/verify/evidence"
    mock_action_handler.request.body = b""
