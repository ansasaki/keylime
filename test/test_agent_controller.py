...
class TestAgentControllerIndex(unittest.TestCase):
    ...
    def test_index_v3_returns_404(self):
        """Test that v3+ index returns 404."""
...
class TestAgentControllerShow(unittest.TestCase):
    ...
    def test_show_v3_returns_404(self):
        """Test that v3+ show returns 404."""
        controller = _v3_controller()
        controller.respond = MagicMock()

        controller.show("test-uuid")
...
class TestAgentControllerCreate(unittest.TestCase):
    ...
    def test_create_v3_returns_404(self):
        """Test that v3+ create returns 404."""
        controller = _v3_controller()
        controller.respond = MagicMock()
...
class TestAgentControllerDelete(unittest.TestCase):
    ...
    def test_delete_v3_returns_404(self):
        """Test that v3+ delete returns 404."""
        controller = _v3_controller()
        controller.respond = MagicMock()

        controller.delete("test-uuid")
